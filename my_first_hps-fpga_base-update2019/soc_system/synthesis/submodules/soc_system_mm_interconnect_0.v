...
module soc_system_mm_interconnect_0 (
		...
		output wire [6:0]  my_aes128_ip_0_aps_s0_paddr,                            //                            my_aes128_ip_0_aps_s0.paddr
		output wire        my_aes128_ip_0_aps_s0_psel,                             //                                                 .psel
		output wire        my_aes128_ip_0_aps_s0_penable,                          //                                                 .penable
		output wire        my_aes128_ip_0_aps_s0_pwrite,                           //                                                 .pwrite
		output wire [31:0] my_aes128_ip_0_aps_s0_pwdata,                           //                                                 .pwdata
		input  wire [31:0] my_aes128_ip_0_aps_s0_prdata,                           //                                                 .prdata
		input  wire        my_aes128_ip_0_aps_s0_pready,                           //                                                 .pready
		...
		input  wire        my_aes128_ip_0_reset_reset_bridge_in_reset_reset,       //       my_aes128_ip_0_reset_reset_bridge_in_reset.reset
	...
	wire    [6:0] my_aes128_ip_0_aps_s0_agent_altera_apb_master_paddr;                                // my_aes128_ip_0_aps_s0_agent:paddr -> my_aes128_ip_0_aps_s0_translator:s0_paddr
	wire          my_aes128_ip_0_aps_s0_agent_altera_apb_master_pready;                               // my_aes128_ip_0_aps_s0_translator:s0_pready -> my_aes128_ip_0_aps_s0_agent:pready
	wire   [31:0] my_aes128_ip_0_aps_s0_agent_altera_apb_master_prdata;                               // my_aes128_ip_0_aps_s0_translator:s0_prdata -> my_aes128_ip_0_aps_s0_agent:prdata
	wire          my_aes128_ip_0_aps_s0_agent_altera_apb_master_pslverr;                              // my_aes128_ip_0_aps_s0_translator:s0_pslverr -> my_aes128_ip_0_aps_s0_agent:pslverr
	wire   [31:0] my_aes128_ip_0_aps_s0_agent_altera_apb_master_pwdata;                               // my_aes128_ip_0_aps_s0_agent:pwdata -> my_aes128_ip_0_aps_s0_translator:s0_pwdata
	wire          my_aes128_ip_0_aps_s0_agent_altera_apb_master_penable;                              // my_aes128_ip_0_aps_s0_agent:penable -> my_aes128_ip_0_aps_s0_translator:s0_penable
	wire          my_aes128_ip_0_aps_s0_agent_altera_apb_master_psel;                                 // my_aes128_ip_0_aps_s0_agent:psel -> my_aes128_ip_0_aps_s0_translator:s0_psel
	wire          my_aes128_ip_0_aps_s0_agent_altera_apb_master_pwrite;                               // my_aes128_ip_0_aps_s0_agent:pwrite -> my_aes128_ip_0_aps_s0_translator:s0_pwrite
	wire          my_aes128_ip_0_aps_s0_agent_altera_apb_master_paddr31;                              // my_aes128_ip_0_aps_s0_agent:paddr31 -> my_aes128_ip_0_aps_s0_translator:s0_paddr31
	...
	wire          my_aes128_ip_0_aps_s0_agent_rp_valid;                                               // my_aes128_ip_0_aps_s0_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] my_aes128_ip_0_aps_s0_agent_rp_data;                                                // my_aes128_ip_0_aps_s0_agent:rp_data -> router_009:sink_data
	wire          my_aes128_ip_0_aps_s0_agent_rp_ready;                                               // router_009:sink_ready -> my_aes128_ip_0_aps_s0_agent:rp_ready
	wire          my_aes128_ip_0_aps_s0_agent_rp_startofpacket;                                       // my_aes128_ip_0_aps_s0_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          my_aes128_ip_0_aps_s0_agent_rp_endofpacket;                                         // my_aes128_ip_0_aps_s0_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> my_aes128_ip_0_aps_s0_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> my_aes128_ip_0_aps_s0_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // my_aes128_ip_0_aps_s0_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> my_aes128_ip_0_aps_s0_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> my_aes128_ip_0_aps_s0_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> my_aes128_ip_0_aps_s0_burst_adapter:sink0_endofpacket
	wire          my_aes128_ip_0_aps_s0_burst_adapter_source0_valid;                                  // my_aes128_ip_0_aps_s0_burst_adapter:source0_valid -> my_aes128_ip_0_aps_s0_agent:cp_valid
	wire  [128:0] my_aes128_ip_0_aps_s0_burst_adapter_source0_data;                                   // my_aes128_ip_0_aps_s0_burst_adapter:source0_data -> my_aes128_ip_0_aps_s0_agent:cp_data
	wire          my_aes128_ip_0_aps_s0_burst_adapter_source0_ready;                                  // my_aes128_ip_0_aps_s0_agent:cp_ready -> my_aes128_ip_0_aps_s0_burst_adapter:source0_ready
	wire    [5:0] my_aes128_ip_0_aps_s0_burst_adapter_source0_channel;                                // my_aes128_ip_0_aps_s0_burst_adapter:source0_channel -> my_aes128_ip_0_aps_s0_agent:cp_channel
	wire          my_aes128_ip_0_aps_s0_burst_adapter_source0_startofpacket;                          // my_aes128_ip_0_aps_s0_burst_adapter:source0_startofpacket -> my_aes128_ip_0_aps_s0_agent:cp_startofpacket
	wire          my_aes128_ip_0_aps_s0_burst_adapter_source0_endofpacket;                            // my_aes128_ip_0_aps_s0_burst_adapter:source0_endofpacket -> my_aes128_ip_0_aps_s0_agent:cp_endofpacket
	...
	altera_merlin_apb_translator #(
		...
		.USE_M0_PADDR31 (0),
		.USE_M0_PSLVERR (0)
	) my_aes128_ip_0_aps_s0_translator (
		.s0_paddr   (my_aes128_ip_0_aps_s0_agent_altera_apb_master_paddr),   //        s0.paddr
		.s0_psel    (my_aes128_ip_0_aps_s0_agent_altera_apb_master_psel),    //          .psel
		.s0_penable (my_aes128_ip_0_aps_s0_agent_altera_apb_master_penable), //          .penable
		.s0_pwrite  (my_aes128_ip_0_aps_s0_agent_altera_apb_master_pwrite),  //          .pwrite
		.s0_pwdata  (my_aes128_ip_0_aps_s0_agent_altera_apb_master_pwdata),  //          .pwdata
		.s0_prdata  (my_aes128_ip_0_aps_s0_agent_altera_apb_master_prdata),  //          .prdata
		.s0_pslverr (my_aes128_ip_0_aps_s0_agent_altera_apb_master_pslverr), //          .pslverr
		.s0_pready  (my_aes128_ip_0_aps_s0_agent_altera_apb_master_pready),  //          .pready
		.s0_paddr31 (my_aes128_ip_0_aps_s0_agent_altera_apb_master_paddr31), //          .paddr31
		.clk        (clk_0_clk_clk),                                         //       clk.clk
		.reset      (my_aes128_ip_0_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.m0_paddr   (my_aes128_ip_0_aps_s0_paddr),                           //        m0.paddr
		.m0_psel    (my_aes128_ip_0_aps_s0_psel),                            //          .psel
		.m0_penable (my_aes128_ip_0_aps_s0_penable),                         //          .penable
		.m0_pwrite  (my_aes128_ip_0_aps_s0_pwrite),                          //          .pwrite
		.m0_pwdata  (my_aes128_ip_0_aps_s0_pwdata),                          //          .pwdata
		.m0_prdata  (my_aes128_ip_0_aps_s0_prdata),                          //          .prdata
		.m0_pready  (my_aes128_ip_0_aps_s0_pready),                          //          .pready
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (my_aes128_ip_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~my_aes128_ip_0_reset_reset_bridge_in_reset_reset), //        clk_reset.reset_n
	...
	altera_merlin_apb_slave_agent #(
		...
		.ST_CHANNEL_W              (6),
		.ST_DATA_W                 (129)
	) my_aes128_ip_0_aps_s0_agent (
		.paddr            (my_aes128_ip_0_aps_s0_agent_altera_apb_master_paddr),       // altera_apb_master.paddr
		.psel             (my_aes128_ip_0_aps_s0_agent_altera_apb_master_psel),        //                  .psel
		.penable          (my_aes128_ip_0_aps_s0_agent_altera_apb_master_penable),     //                  .penable
		.pwrite           (my_aes128_ip_0_aps_s0_agent_altera_apb_master_pwrite),      //                  .pwrite
		.pwdata           (my_aes128_ip_0_aps_s0_agent_altera_apb_master_pwdata),      //                  .pwdata
		.pready           (my_aes128_ip_0_aps_s0_agent_altera_apb_master_pready),      //                  .pready
		.prdata           (my_aes128_ip_0_aps_s0_agent_altera_apb_master_prdata),      //                  .prdata
		.pslverr          (my_aes128_ip_0_aps_s0_agent_altera_apb_master_pslverr),     //                  .pslverr
		.paddr31          (my_aes128_ip_0_aps_s0_agent_altera_apb_master_paddr31),     //                  .paddr31
		.cp_valid         (my_aes128_ip_0_aps_s0_burst_adapter_source0_valid),         //                cp.valid
		.cp_ready         (my_aes128_ip_0_aps_s0_burst_adapter_source0_ready),         //                  .ready
		.cp_data          (my_aes128_ip_0_aps_s0_burst_adapter_source0_data),          //                  .data
		.cp_channel       (my_aes128_ip_0_aps_s0_burst_adapter_source0_channel),       //                  .channel
		.cp_startofpacket (my_aes128_ip_0_aps_s0_burst_adapter_source0_startofpacket), //                  .startofpacket
		.cp_endofpacket   (my_aes128_ip_0_aps_s0_burst_adapter_source0_endofpacket),   //                  .endofpacket
		.rp_valid         (my_aes128_ip_0_aps_s0_agent_rp_valid),                      //                rp.valid
		.rp_ready         (my_aes128_ip_0_aps_s0_agent_rp_ready),                      //                  .ready
		.rp_data          (my_aes128_ip_0_aps_s0_agent_rp_data),                       //                  .data
		.rp_startofpacket (my_aes128_ip_0_aps_s0_agent_rp_startofpacket),              //                  .startofpacket
		.rp_endofpacket   (my_aes128_ip_0_aps_s0_agent_rp_endofpacket),                //                  .endofpacket
		.clk              (clk_0_clk_clk),                                             //               clk.clk
		.reset            (my_aes128_ip_0_reset_reset_bridge_in_reset_reset)           //         clk_reset.reset
	);
	...
	soc_system_mm_interconnect_0_router_009 router_009 (
		.sink_ready         (my_aes128_ip_0_aps_s0_agent_rp_ready),             //      sink.ready
		.sink_valid         (my_aes128_ip_0_aps_s0_agent_rp_valid),             //          .valid
		.sink_data          (my_aes128_ip_0_aps_s0_agent_rp_data),              //          .data
		.sink_startofpacket (my_aes128_ip_0_aps_s0_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (my_aes128_ip_0_aps_s0_agent_rp_endofpacket),       //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (my_aes128_ip_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) my_aes128_ip_0_aps_s0_burst_adapter (
		.clk                   (clk_0_clk_clk),                                             //       cr0.clk
		.reset                 (my_aes128_ip_0_reset_reset_bridge_in_reset_reset),          // cr0_reset.reset
		...
		.source0_valid         (my_aes128_ip_0_aps_s0_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (my_aes128_ip_0_aps_s0_burst_adapter_source0_data),          //          .data
		.source0_channel       (my_aes128_ip_0_aps_s0_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (my_aes128_ip_0_aps_s0_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (my_aes128_ip_0_aps_s0_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (my_aes128_ip_0_aps_s0_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (my_aes128_ip_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
